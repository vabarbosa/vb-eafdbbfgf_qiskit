...
from qiskit.aqua.utils.dataset_helper import map_label_to_class_name
...
def iris(training_size, test_size, n, plot_data=False, one_hot=True):
    ...
    training_feature_array, training_label_array = map_label_to_class_name(
        training_input, class_labels, one_hot
    )
    test_feature_array, test_label_array = map_label_to_class_name(
